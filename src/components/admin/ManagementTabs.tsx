...
import { BarChart3, Ticket, Users2, UserCheck, Bell, Database, Activity, AlertTriangle, Clock, Mail } from 'lucide-react';
...
export function ManagementTabs({ activeTab, setActiveTab }: ManagementTabsProps) {
  const managementTabs = [
    ...
    { id: 'notifications', name: 'Notifications', icon: Mail, color: 'bg-indigo-50 text-indigo-700 border-indigo-600' },
