    ...
    const loginReq = http.request(loginOptions, (loginRes) => {
      ...
      loginRes.on('end', () => {
        ...
        if (loginRes.statusCode === 200) {
          ...
          // 2. Test de la route /workflows (comme le frontend)
            ...
            workflowsRes.on('end', () => {
              ...
              if (workflowsRes.statusCode === 200) {
                ...
                if (workflows.workflows.length > 0) {
                  ...
                  // 3. Test de l'analyse avec EXACTEMENT les mêmes headers que le frontend
                  console.log('3️⃣ Test analyse avec headers frontend...');
