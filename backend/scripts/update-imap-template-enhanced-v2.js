        ...
        "nodes": [
          ...
          },
          {
            "parameters": {
              ...
              "subject": "=✅ Rapport Transfert IMAP - {{ $json.count }} email(s) transféré(s) dans {{ $json.folders }} dossier(s)",
              "emailFormat": "html",
              "html": "={{ $json.html }}",
              "options": {}
            },
