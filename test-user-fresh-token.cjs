...
async function testUserFreshToken() {
  try {
    console.log('🔍 Test avec utilisateur normal et token frais...');
    
    // 1. Connexion avec l'utilisateur normal
    ...
    const loginReq = http.request(loginOptions, (loginRes) => {
      ...
      loginRes.on('end', () => {
        ...
        if (loginRes.statusCode === 200) {
                  ...
                  const analyzeReq = http.request(analyzeOptions, (analyzeRes) => {
                    ...
                    analyzeRes.on('end', () => {
                      ...
                      if (analyzeRes.statusCode === 200) {
                        console.log('🎉 SUCCÈS ! L\'analyse fonctionne pour l\'utilisateur normal !');
          ...
          console.log('❌ Échec connexion utilisateur normal');
